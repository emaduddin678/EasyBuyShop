  ...
  return (
    <footer className="px-4 divide-y bg-gray-800 text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-3/4 sm:grid-cols-4">
          <div className="space-y-3 mx-auto pr-5 md:pr-0">
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © 2024 EasyBuyShop. All rights reserved.
      </div>
    </footer>
  );
};
